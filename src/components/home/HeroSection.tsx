...
export function HeroSection() {
  return (
    <section className="relative isolate -mt-[50px] flex min-h-[644px] items-start justify-center overflow-hidden px-4 pb-[15px] pt-[105px] sm:px-10 sm:pb-24 md:-mt-20 lg:min-h-[809px] lg:items-center lg:px-20 lg:pb-[92px] lg:pt-[132px]">
