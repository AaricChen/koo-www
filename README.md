...
- Chrome must fit `body` `min-width: 320px`: header logo/CTA are fluid; Start Trading uses `w-full max-w-[300px]`. Primary nav is `md+`; a Docs link stays visible below `md`.
