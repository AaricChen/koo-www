...
function FeatureTag({ label }: { label: string }) {
  return (
    <span className="experience-tag inline-flex h-6 shrink-0 items-center rounded-[18px] border border-secondary px-2 text-xs leading-3 text-secondary lg:h-[34px] lg:px-3.5 lg:text-sm lg:leading-[14px]">
      {label}
    </span>
  )
}
